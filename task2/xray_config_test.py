...
# =============================常改的参数=============================
parser.add_argument('--Task_name', type=str, default='Xray_try')  # 任务名,也是文件名
...
parser.add_argument('--filepath_img', type=str, default=r'/home/nas/pzh/PENGWIN/task2/one_stage/h5_data')
# 用于分折的csv表格
parser.add_argument('--csv_file', type=str, default=r'/home/nas/pzh/code/MyModel_Seg_A100/seg_code_2d/Xray_train_v2/file_names.csv')
# result&save
parser.add_argument('--result_path', type=str, default=r'/home/nas/pzh/PENGWIN/task2/one_stage/seg_result/')  # 结果保存地址
# model hyper-parameters
parser.add_argument('--image_size', type=int, default=448)
parser.add_argument('--model_name', type=str, default='smp.UnetPlusPlus')  # 模型框架
...
parser.add_argument('--save_model_step', type=int, default=100)  # 多少epoch保存一次模型
