...
from resources.nnunetv2.training.nnUNetTrainer.variants.network_architecture.NexToU import NexToU
...
class nnUNetTrainer_NexToU_ep500_CosAnneal(nnUNetTrainer):
